        ...
        <div class="joms-focus__actions__wrapper">
            <div class="joms-focus__actions--desktop">
                ...
                <?php } elseif(!$isBanned) { ?>
                    ...
                    -->
                    <a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=joinmembership&groupid=' . $group->id); ?>" class="joms-focus__button--message" ><?php echo JText::_('COM_COMMUNITY_GROUPS_JOIN'); ?></a>
                <?php } ?>
            </div>
