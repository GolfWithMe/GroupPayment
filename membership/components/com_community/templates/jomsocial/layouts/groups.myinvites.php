    ...
    ?>
        <li id="groups-invite-<?php echo $group->id;?>" class="joms-list__item">
            ...
            <span class="joms-list__permission joms-js--invitation-buttons-group-<?php echo $group->id; ?>">
                ...
                -->
                <a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=joinmembership&groupid=' . $group->id); ?>" class="joms-button--primary joms-button--smallest" ><?php echo JText::_('COM_COMMUNITY_EVENTS_ACCEPT'); ?></a>
            </span>
        </li>
    <?php
        }
